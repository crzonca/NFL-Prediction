...
def set_up_teams():
    ...
    teams.append(create_base_team('Chargers', 1568.015))
    teams.append(create_base_team('Chiefs', 1575.108))
    teams.append(create_base_team('Colts', 1537.46))
    teams.append(create_base_team('Cowboys', 1526.138))
    teams.append(create_base_team('Dolphins', 1378.685))
    ...
    teams.append(create_base_team('Jaguars', 1469.121))
    teams.append(create_base_team('Jets', 1419.061))
    teams.append(create_base_team('Lions', 1457.254))
    teams.append(create_base_team('Packers', 1529.549))
    ...
    teams.append(create_base_team('Saints', 1584.247))
    teams.append(create_base_team('Seahawks', 1533.368))
    teams.append(create_base_team('Steelers', 1540.325))
    teams.append(create_base_team('Texans', 1533.504))
    teams.append(create_base_team('Titans', 1487.4))
    teams.append(create_base_team('Vikings', 1528.867))
