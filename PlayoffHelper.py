...
def get_pre_week1_schedule():
    ...
    games.append(create_match_up('Giants', 'Jets', 2))
    games.append(create_match_up('Eagles', 'Titans', -3.5))
    games.append(create_match_up('Bears', 'Panthers', -3.5))
    games.append(create_match_up('Lions', 'Patriots', 1.5))
    ...
    games.append(create_match_up('49ers', 'Cowboys', -3.5))
    games.append(create_match_up('Seahawks', 'Broncos', -3))
    games.append(create_match_up('Bills', 'Colts', 0))
    games.append(create_match_up('Dolphins', 'Falcons', -1.5))
    games.append(create_match_up('Ravens', 'Jaguars', -4))
    games.append(create_match_up('Browns', 'Redskins', -1.5))
    games.append(create_match_up('Steelers', 'Buccaneers', -2.5))
    games.append(create_match_up('Chiefs', 'Bengals', -4))
    games.append(create_match_up('Raiders', 'Rams', -4))
