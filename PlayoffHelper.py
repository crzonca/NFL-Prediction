...
def get_pre_week2_schedule():
    games = list()
    # Games are listed as: Home Team, Away Team, Spread if Home is favored (-1 * spread otherwise), neutral location
    games.append(create_match_up('Giants', 'Bears', -2))
    ...
    games.append(create_match_up('Panthers', 'Bills', -3))
    games.append(create_match_up('Buccaneers', 'Dolphins', -3))
    ...
    games.append(create_match_up('Texans', 'Lions', -3))
    games.append(create_match_up('Colts', 'Browns', -3))
    games.append(create_match_up('Jaguars', 'Eagles', -3))
    games.append(create_match_up('Titans', 'Patriots', 3))
    games.append(create_match_up('Broncos', '49ers', -2))
    games.append(create_match_up('Chargers', 'Saints', -3))
